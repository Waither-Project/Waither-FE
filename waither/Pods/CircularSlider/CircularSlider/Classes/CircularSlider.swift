...
open class CircularSlider: UIView {
    ...
    fileprivate var intFont = UIFont(name: "SF Pro Bold", size: 50)
    fileprivate var decimalFont = UIFont(name: "SF Pro Medium", size: 50)
    fileprivate var divisaFont = UIFont(name: "SF Pro Medium", size: 26)
    ...
    fileprivate func configureFont() {
        if #available(iOS 8.2, *) {
            intFont = UIFont(name: "SF Pro Bold", size: 50)!
            decimalFont = UIFont(name: "SF Pro Medium", size: 50)!
            divisaFont = UIFont(name: "SF Pro Medium", size: 26)!
        }
    }
