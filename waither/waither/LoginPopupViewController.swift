...
class LoginPopupViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        attributedString.addAttribute(.font, value: UIFont.fontWithName(type: .bold, size: 18), range: (alertLabel.text! as NSString).range(of: "데이터"))
        
        attributedString.addAttribute(.font, value: UIFont.fontWithName(type: .bold, size: 18), range: (alertLabel.text! as NSString).range(of: "저장되지 않아요!"))
