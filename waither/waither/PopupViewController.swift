...
extension NSMutableAttributedString {
    ...
    var boldFont: UIFont {
        return UIFont(name: "AppleSDGothicNeoB00", size: fontSize) ?? UIFont.boldSystemFont(ofSize: fontSize)
    }
    var normalFont: UIFont {
        return UIFont(name: "AppleSDGothicNeoM00", size: fontSize) ?? UIFont.systemFont(ofSize: fontSize)
    }
...
class PopupViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        logoutLabel?.attributedText = NSMutableAttributedString()
            ...
            .regular(string: "그래도 로그아웃해드릴까요?", fontSize: 15)
